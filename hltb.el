...
(defun hltb-org-set-release-date (game prop name)
  (when-let ((release-date (alist-get prop (hltb-game-release-date game))))
    (org-set-property name (hltb-org-make-link (hltb-org-convert-date release-date)))))
...
(defun hltb-org-fill-properties ()
  ...
  (let ((title (org-element-property :title (org-element-at-point))))
    ...
    (let* ((search-entry (hltb-search title))
      ...
      (save-excursion
        (org-set-property "ID" (concat "hltb-id-" (number-to-string (hltb-game-id game))))
        ...
        (hltb-org-set-release-date game 'na "HLTB-RELEASE-DATE-NA")
        (hltb-org-set-release-date game 'eu "HLTB-RELEASE-DATE-EU")
        (hltb-org-set-release-date game 'jp "HLTB-RELEASE-DATE-JP"))
