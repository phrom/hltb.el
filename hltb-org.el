...
(defun hltb-org-fill-properties ()
  ...
  (let ((title (org-element-property :title (org-element-at-point))))
    ...
    (let ((entry (hltb-search title))
      ...
      (org-set-property "HLTB-MAIN" (hltb-org-duration-to-string (hltb-entry-main entry)))
      (org-set-property "HLTB-MAIN+EXTRA" (hltb-org-duration-to-string (hltb-entry-main+extra entry)))
      (org-set-property "HLTB-COMPLETIONIST" (hltb-org-duration-to-string (hltb-entry-completionist entry)))
